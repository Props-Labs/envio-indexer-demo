...
export type TestEventInput = { amount: BigNumberish };
export type TestEventOutput = { amount: BN };

export interface ContractContractAbiInterface extends Interface {
  functions: {
...
export class ContractContractAbi extends Contract {
  interface: ContractContractAbiInterface;
  functions: {
    owner: InvokeFunction<[], StateOutput>;
    constructor: InvokeFunction<[owner: IdentityInput, name: StdString], void>;
    test_function: InvokeFunction<[], BN>;
  };
}
